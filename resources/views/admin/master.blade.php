...
<head>
    ...
    <title>{{ \App\Helpers\SiteHelper::aboutUs()->name }} - Admin Dashboard</title>
    <meta content="width=device-width, initial-scale=1.0, shrink-to-fit=no" name="viewport"/>
    <link rel="icon" href="{{ asset('upload/aboutUs/'. \App\Helpers\SiteHelper::aboutUs()->logo) }}" type="image/x-icon"/>
...
<script src="{{ asset('dashboard/assets/js/setting-demo2.js') }}"></script>
<script>
